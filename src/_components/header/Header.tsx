  ...
  return (
    <header className="bg-gray-900 sticky top-0 z-10 py-5 border-b border-gray-700 shadow-md">
      <nav className="flex flex-wrap items-center justify-between gap-4">
        ...
        <Link href={"/cart"} className="go-to-cart flex items-center gap-2 cursor-pointer hover:opacity-80 transition">
          <BsCart3 size="1.8em" />
          <div className="text-center">
            <div className="bg-indigo-600 text-white px-2 rounded-full text-sm font-medium">0
              {/* {cart.length} */}
            </div>
